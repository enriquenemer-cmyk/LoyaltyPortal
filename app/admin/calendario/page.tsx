    ...
    <div className="min-h-screen bg-[#FAFAF9] p-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-extrabold text-[#1C1917] tracking-tight">Calendario de Premios</h1>
          <p className="text-sm text-[#78716c] mt-1">Visualiza los premios activos, por vencer y expirados por día.</p>
        </div>
