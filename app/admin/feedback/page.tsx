  ...
  return (
    <div className="min-h-screen bg-[#FAFAF9] p-6 md:p-10">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <p className="text-xs font-bold text-[#2563EB] uppercase tracking-widest mb-1">Análisis</p>
          <h1 className="text-2xl font-bold text-[#1C1917]">Satisfacción del Cliente</h1>
          <p className="text-sm text-stone-500 mt-1">Calificaciones y comentarios post-visita de los tickets escaneados</p>
        </div>
