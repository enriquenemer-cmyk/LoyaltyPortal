...
export async function POST(request: NextRequest) {
  try {
    ...
    const restaurant = await insertRestaurant({ id: randomUUID(), name, address, phone: phone || null, logo_url: null, accent_color: accent_color || '#2563EB', google_maps_url: google_maps_url || null, lat: null, lng: null });
