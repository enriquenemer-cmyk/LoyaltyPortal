...
export default function CashierAction({ claimId, prizeName, defaultCajero = '', phone, fullName, isExpired = false, googleMapsUrl }: Props) {
      ...
      <div className="text-center py-4 space-y-6">
        {showConfetti && (
          <div style={{ position:'fixed', inset:0, pointerEvents:'none', zIndex:999, overflow:'hidden' }}>
            ...
            {['#F97316','#FB923C','#f9a8d4','#818cf8','#34d399','#F97316','#FB923C','#f9a8d4','#818cf8','#34d399','#F97316','#FB923C','#f9a8d4','#818cf8','#34d399','#F97316'].map((c,i) => (
        ...
        <div className="bg-stone-50 border border-stone-200 rounded-2xl px-5 py-4 space-y-3">
          <div className="w-full bg-stone-200 rounded-full h-1.5 overflow-hidden">
            <div
              className="h-1.5 rounded-full bg-[#F97316] transition-all duration-1000"
        ...
        {googleMapsUrl && (
          <div className="bg-white border border-orange-200 rounded-2xl p-5 text-left space-y-3">
  ...
  return (
    <div className="space-y-5">
      ...
      {isExpired && (
        <div className="bg-orange-50 border border-orange-300 rounded-xl px-4 py-3.5 flex items-start gap-3">
          ...
          <p className="text-orange-800 text-sm font-semibold leading-snug">
        ...
        <button
          ...
          style={{
            ...
            boxShadow: isExpired
              ...
              : '0 12px 36px rgba(249,115,22,0.50)',
