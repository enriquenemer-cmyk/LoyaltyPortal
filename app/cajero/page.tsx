        ...
        <div className="max-w-5xl mx-auto px-5 py-4 flex items-center gap-3">
          ...
          <button
            onClick={() => {
              ...
              window.location.href = `/api/admin/export/cajero?date=${today}`;
            }}
            className="flex items-center gap-1.5 text-xs font-bold px-3 py-2 rounded-lg border transition-all"
            style={{ border: '2px solid #F97316', color: '#EA580C', background: '#FFF7ED' }}
            title="Descargar reporte de canjes del día"
          >
