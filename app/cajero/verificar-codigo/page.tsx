...
export default function VerificarCodigoPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF9]">
      {/* Header */}
      <div className="sticky top-0 z-20 shadow-md" style={{ background: `linear-gradient(135deg, #E8521A, #C2410C)` }}>
      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-5">
        ...
        <div className="bg-white rounded-3xl border border-[#E8E3DC] overflow-hidden" style={{ boxShadow: '0 1px 2px rgba(28,25,23,0.04), 0 8px 32px rgba(28,25,23,0.08)' }}>
          ...
          <div className="p-5 space-y-4">
            ...
            <button
              ...
              style={{ background: `linear-gradient(135deg, #E8521A, #C2410C)`, boxShadow: '0 10px 32px rgba(232,82,26,0.35)' }}
            >
              {loading ? (
            ...
            <div className="p-5 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  style={{ '--tw-ring-color': '#E8521A40' } as React.CSSProperties}
                />
              </div>
        ...
        {result?.status === 'expired' && (
          <div className="bg-white rounded-3xl border border-amber-200 overflow-hidden" style={{ boxShadow: '0 8px 32px rgba(245,158,11,0.10)' }}>
            <div className="px-5 py-4 bg-amber-50 border-b border-amber-200 flex items-center gap-3">
              ...
              <div>
                <p className="text-amber-800 font-extrabold text-base">Codigo expirado</p>
                <p className="text-amber-600 text-xs">Este codigo ya no es valido</p>
              </div>
            </div>
            <div className="p-5">
              <div className="bg-[#FAFAF9] border border-[#E8E3DC] rounded-2xl px-4 py-3">
