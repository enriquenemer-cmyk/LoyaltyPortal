...
const CONFETTI_COLORS = ['#E8521A', '#fb923c', '#fbbf24', '#34d399', '#60a5fa', '#a78bfa', '#f472b6'];
...
const TOUR_STEPS: TourStep[] = [
  {
    id: 1,
    message: '👋 Bienvenido a Premia Tierra. Te mostramos cómo funciona en 4 pasos.',
    targetSelector: null,
    position: 'center',
  },
  {
      ...
      {highlightRect && (
        <div
          ...
          style={{
            ...
            boxShadow: '0 0 0 3px #E8521A, 0 0 0 6px rgba(232,82,26,0.25)',
          }}
          aria-hidden="true"
        />
      )}
            ...
            {TOUR_STEPS.map((_, i) => (
              <div
                ...
                style={{
                  ...
                  height: 8,
                  background: i + 1 === tourStep ? '#E8521A' : i + 1 < tourStep ? '#fb923c' : '#e7e5e4',
                }}
              />
            ))}
          </div>
