  ...
  return (
    <div className="min-h-screen bg-[#FAFAF9] flex flex-col items-center justify-center gap-6 px-4 text-center">
      ...
      <div className="flex items-center gap-2 mb-2">
        <div className="w-8 h-8 rounded-full flex items-center justify-center text-white text-sm font-black" style={{ background: 'linear-gradient(135deg,#E8521A,#C2410C)' }}>
          P
        </div>
        <span className="text-sm font-bold text-stone-500 uppercase tracking-widest">Tierra Burrito Bar</span>
      </div>

      {/* Error number */}
      <span
        className="text-9xl font-black leading-none select-none"
        style={{ background: 'linear-gradient(135deg, #E8521A 0%, #f97316 50%, #fbbf24 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}
      >
        500
      </span>
      ...
      <p className="text-xs text-stone-300 mt-4">Premia Tierra &mdash; Tierra Burrito Bar</p>
    </div>
  )
}
