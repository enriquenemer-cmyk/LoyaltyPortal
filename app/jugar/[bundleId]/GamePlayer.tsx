...
const ORANGE_SHADES = ['#F97316', '#EA580C', '#C2410C', '#F97316', '#c2410c', '#FDBA74', '#7C2D12', '#FED7AA'];
  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      <div
        ...
        style={{ top: -6, left: '50%', transform: 'translateX(-50%)', width: 0, height: 0, borderLeft: '10px solid transparent', borderRight: '10px solid transparent', borderTop: '20px solid #F97316' }}
      />
      <svg
        width={size}
        height={size}
      ...
      >
        ...
        <circle cx={cx} cy={cy} r={18} fill="#1C1917" stroke="#F97316" strokeWidth={3} />
        <text x={cx} y={cy} textAnchor="middle" dominantBaseline="middle" fill="#F97316" fontSize={10} fontWeight="bold">PT</text>
      </svg>
    </div>
  );
}
    ...
    <div className="flex gap-3 justify-center">
      {reels.map((idx, i) => (
        <div
          ...
          style={{ background: '#FFF7F3', borderColor: '#F97316', color: '#1C1917', padding: 8 }}
        >
...
function PenaltyGame({
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      {/* Goal */}
      <div className="relative w-64 h-36 border-4 rounded-b-lg flex items-center justify-center" style={{ borderColor: '#F97316', background: 'rgba(249,115,22,0.08)' }}>
        <span className="text-[#a8a29e] text-sm font-bold tracking-widest uppercase">Portería</span>
        {revealed && chosen !== null && (
          <div className="absolute inset-0 flex items-center justify-center rounded-b-lg" style={{ background: 'rgba(249,115,22,0.9)' }}>
      ...
      <div className="grid grid-cols-3 gap-2">
        {zones.map((prize, i) => (
          <button
            ...
            style={{
              background: chosen === i ? (revealed ? '#F97316' : '#FFF0E8') : '#FAFAF9',
              borderColor: chosen === i ? '#F97316' : '#E8E3DC',
        ...
        {prizes.map((prize, i) => {
          ...
          return (
            <button
              ...
              style={{
                background: isScratched ? (isWinner ? '#F97316' : '#FAFAF9') : '#E8E3DC',
                borderColor: isScratched && isWinner ? '#F97316' : '#E8E3DC',
...
function Confetti() {
  const colors = ['#F97316', '#F97316', '#FDBA74', '#FFEDD5', '#fff'];
  return (
...
export default function GamePlayer({
  ...
  const inputCls = [
    ...
    'focus:outline-none focus:ring-2 focus:ring-[#F97316]/20 focus:border-[#F97316] transition-all',
  ].join(' ');
  ...
  if (gameState === 'ready') {
    return (
      <div className="min-h-screen" style={{ background: '#FAFAF9' }}>
        {/* Header */}
        <div style={{ background: 'linear-gradient(135deg,#F97316,#EA580C)' }} className="px-5 pt-10 pb-8 text-center">
        ...
        <div className="min-h-screen flex flex-col items-center justify-center px-4 py-10" style={{ background: '#FAFAF9' }}>
          <div className="w-full max-w-md text-center">
            <div
              ...
              style={{ background: 'linear-gradient(135deg,#F97316,#EA580C)', boxShadow: '0 12px 40px rgba(249,115,22,0.45)' }}
            >
              <span className="text-5xl"><GiftIcon className="w-5 h-5 inline-block align-middle" aria-hidden="true" /></span>
            </div>
            <p className="text-[10px] font-bold text-[#F97316] uppercase tracking-widest mb-2">¡Felicidades!</p>
  ...
  if (gameState === 'claiming') {
    return (
      <div className="min-h-screen" style={{ background: '#FAFAF9' }}>
        {/* Prize banner */}
        <div style={{ background: 'linear-gradient(135deg,#F97316,#EA580C)' }} className="px-5 pt-8 pb-6 text-center">
        ...
        <div className="bg-white rounded-2xl border border-[#E8E3DC] overflow-hidden" style={{ boxShadow: '0 4px 20px rgba(28,25,23,0.10)' }}>
          <div className="px-5 py-4 border-b border-[#E8E3DC]" style={{ background: '#FAFAF9' }}>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[10px] font-bold text-[#F97316] uppercase tracking-widest">3E</p>
            ...
            {[
              ...
              <div key={label} className="flex items-center justify-between">
                ...
                <span
                  ...
                  style={{ color: accent ? '#F97316' : '#1C1917' }}
                >
                  {value}
                </span>
              </div>
          ...
          <div className="px-5 py-4 bg-orange-50">
            <p className="text-[#F97316] text-xs font-bold text-center">
