    ...
    <>
      ...
      <div style={{ minHeight: '100vh', background: '#FAFAF9' }}>
        ...
        <div className="s1" style={{
          background: 'linear-gradient(160deg, #E8521A 0%, #C2410C 50%, #7C2D12 100%)',
        ...
        <div style={{ maxWidth: 440, margin: '0 auto', padding: '20px 16px 60px' }}>
          ...
          <div className="s2" style={{ background: 'white', borderRadius: 24, border: '1px solid #E8E3DC', overflow: 'hidden', marginBottom: 14, boxShadow: '0 2px 16px rgba(28,25,23,0.07)' }}>
            ...
            {prize.reason && (
              <div style={{ padding: '18px 20px', borderBottom: '1px solid #F0EDE8', display: 'flex', alignItems: 'flex-start', gap: 14 }}>
                <div style={{ width: 42, height: 42, borderRadius: 14, background: '#fff7ed', border: '1px solid #fed7aa', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, flexShrink: 0 }}>🏆</div>
                <div>
                  <p style={{ color: '#E8521A', fontSize: 10, fontWeight: 800, letterSpacing: '0.14em', textTransform: 'uppercase', marginBottom: 4 }}>Por qué lo ganaste</p>
            ...
            {prize.description && (
              <div style={{ padding: '18px 20px', borderBottom: '1px solid #F0EDE8', display: 'flex', alignItems: 'flex-start', gap: 14 }}>
                <div style={{ width: 42, height: 42, borderRadius: 14, background: '#fff7ed', border: '1px solid #fed7aa', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, flexShrink: 0 }}>🎁</div>
                <div style={{ flex: 1 }}>
                  <p style={{ color: '#E8521A', fontSize: 10, fontWeight: 800, letterSpacing: '0.14em', textTransform: 'uppercase', marginBottom: 4 }}>En qué consiste</p>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', marginBottom: 14 }}>
                    {[
                      ...
                      <div key={n} style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', position: 'relative' }}>
                        ...
                        <span style={{ fontSize: 10, fontWeight: 700, color: done ? '#E8521A' : '#a8a29e' }}>{label}</span>
                      </div>
                    ))}
                  </div>
          ...
          <p style={{ textAlign: 'center', color: '#c4bfb8', fontSize: 11, marginTop: 24, letterSpacing: '0.04em' }}>
            Tierra Burrito Bar · Plataforma de Premios
          </p>
        </div>
      </div>
    </>
